                                ...
                                <form action="{{ route('admin.owners.update',['owner'=>$owner->id]) }}" method="post">
                                    ...
                                    <div class="-m-2">
                                        ...
                                        <div class="p-2 w-1/2 mx-auto">
                                            <div class="relative">
                                                <label for="password"
                                                    class="leading-7 text-sm text-gray-600">パスワード確認用</label>
                                        ...
                                        <div class="p-2 w-full flex justify-around mt-4">
                                            ...
                                            <button type="submit"
                                                class="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">更新</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
