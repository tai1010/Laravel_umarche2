                                            ...
                                            <tr>
                                                ...
                                                <td class="md:px-4 py-3">
                                                    <button
                                                        ...
                                                        class="flex mx-auto text-white bg-blue-400 border-0 py-2 px-4 focus:outline-none hover:bg-blue-500 rounded">編集</button>
                                                </td>
                                                <form id="delete_{{ $owner->id }}" method="post"
                                                    ...
                                                    @method('delete')
                                                    <td class="px-1 py-1">
                                                        <button href="#" data-id="{{ $owner->id }}"
                                                            onclick="deletePost(this)"
                                                            class="flex mx-auto text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">削除</button>
                                                    </td>
                                                </form>
                                            </tr>
                                        @endforeach
